...
function setUpdateForm(){
	if($("#tntype").val()=='1'&& $("#tndatasource").val()=='shelves_select')
		...
		document.treeNodeForm.action='/admin/app/cms/DirTreeList/update/dirTreeAction';
		document.treeNodeForm.submit();
	}
}
function setDeleteForm() {
	document.treeNodeForm.action = "/admin/app/cms/DirTreeList/delete/dirTreeAction";
}
$(document).ready(function(){
	var imgseq = '<c:out value="${treeNode.tnpic}"/>';
	if(imgseq!='' && imgseq!=null)
		initImg_showimg(imgseq);
...
<div class="treeSet">
 <ul>
 	<c:if test="${treeNode.tntype != '1' && treeNode.tntype != '3'}">
 		<li><a href="#" onclick="getAddPage(${treeNode.tid}, ${treeNode.tnlevel}, ${treeNode.tnid});"><img src='<c:url value="/app/images/icon_modAdd.gif"/>' alt="資料新增" />資料新增</a></li>
 	</c:if>
...
<!--form-->
<div class="formTb"> 
<form:form commandName="treeNode" name="treeNodeForm"> 
<%-- <form:hidden path="tnid"/> --%>
<form:hidden path="tid"/>
<form:hidden path="tnxpath"/>
<form:hidden path="tnlevel"/>
...
<table summary="資料表格">
              ...
              <tr>
                <th scope="row"><span class="must">*</span>節點Id</th>
                <td><form:input path="tnid" cssClass="text" readonly="true"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><form:input path="tnsort" cssClass="text"/><form:errors path="tnsort" cssStyle="color : red;"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><form:textarea path="tndesc" rows="8" cssClass="text"></form:textarea></td>
              </tr>
              <tr>
