...
<div class="content">
<h2>
			代碼管理<img src='<c:url value="/app/images/path_arrow.gif"/>' alt="&gt;&gt;"><span>子代碼新增</span>
		</h2>
...
<!--form-->
<div class="formTb"> 
<form:form commandName="codeRef" action="/admin/app/admin/CodeRef/insert/codeRefAction" name="codeRefForm">     
<table summary="資料表格">
              <caption>
              ...
              <tr>
                ...
                <td><form:input path="subcodesort" cssClass="text" value="100"/><form:errors path="subcodesort" cssStyle="color : red;"/></td>
              </tr>
              <form:hidden path="refid" value="${refid}"/>
              <form:hidden path="refvalue" value="${refvalue}"/>
