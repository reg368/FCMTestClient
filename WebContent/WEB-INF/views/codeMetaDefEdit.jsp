...
function setUpdateForm(){
	document.codeMetaDefForm.action = "/admin/app/admin/CodeMetaDef/update/codeMetaDefAction";
}
function setDeleteForm() {
	document.codeMetaDefForm.action = "/admin/app/admin/CodeMetaDef/delete/codeMetaDefAction";
}
...
<div class="content">
<h2>
			代碼群組管理<img src='<c:url value="/app/images/path_arrow.gif"/>' alt="&gt;&gt;"><span>代碼群組編輯</span>
		</h2>
...
<!--form-->
<div class="formTb"> 
<form:form commandName="codeMetaDef" name="codeMetaDefForm">
<form:hidden path="codemetaseq"/>   
<table summary="資料表格">
              <caption>
              ...
              <tr>
                ...
                <td><form:input path="codemetatblname" cssClass="text"/><form:errors path="codemetatblname" cssStyle="color : red;"/></td>
              </tr>
              <tr>
                <th scope="row">對照欄位</th>
                <td><form:input path="codemetasrcfld" cssClass="text"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><form:input path="codemetavaluefld" cssClass="text"/><form:errors path="codemetavaluefld" cssStyle="color : red;"/></td>
              </tr>
              <tr>
                <th scope="row"><span class="must">*</span>對照Value欄名稱</th>
                <td><form:input path="codemetavaluefldname" cssClass="text"/><form:errors path="codemetavaluefldname" cssStyle="color : red;"/></td>
              </tr>
              <tr>
                <th scope="row"><span class="must">*</span>對照顯示欄</th>
                <td><form:input path="codemetashowfld" cssClass="text"/><form:errors path="codemetashowfld" cssStyle="color : red;"/></td>
              </tr>
              <tr>
                <th scope="row"><span class="must">*</span>對照顯示欄名稱</th>
                <td><form:input path="codemetashowfldname" cssClass="text"/><form:errors path="codemetashowfldname" cssStyle="color : red;"/></td>
              </tr>
              <tr>
                <th scope="row">對照排序欄</th>
                <td><form:input path="codemetasortfld" cssClass="text"/></td>
              </tr>
              <tr>
                <th scope="row"><span class="must">*</span>對照排序欄名稱</th>
                <td><form:input path="codemetasortfldname" cssClass="text"/><form:errors path="codemetasortfldname" cssStyle="color : red;"/></td>
              </tr>
              <tr>
                <th scope="row">代碼群組類別</th>
                <td><form:input path="codemetatype" cssClass="text"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><form:input path="codemetasort" cssClass="text"/><form:errors path="codemetasort" cssStyle="color : red;"/></td>
              </tr>
            </table>           
...
<div class="aCenter">
        <div class="remark"><span class="must">*</span>必填欄位</div>
            ...
            <c:if test="${limits.delete}"> 
                ...
                <input name="submit2" type="reset" class="btn_reset"  value="取消" onclick="javascript:history.go(-1);"/>
      </div>
		</form:form>    
</div>
