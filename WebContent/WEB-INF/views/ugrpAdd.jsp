...
<body class="layout">
<div class="content">
<h2>權限群組管理<img src='<c:url value="/app/images/path_arrow.gif"/>' alt="&gt;&gt;"><span>權限群組新增</span></h2>
...
<!--form-->
<div class="formTb"> 
<form:form commandName="ugrp" action="/admin/app/admin/Ugrp/insert/ugrpAction" name="ugrpForm" method="POST">
